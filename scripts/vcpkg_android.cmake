...
#
# Modification by luncliff@gmail.com
#   - Condition VCPKG_TARGET_IS_ANDROID to `true`
#   - Comment out VCPKG_CHAINLOAD_TOOLCHAIN_FILE, CMAKE_TOOLCHAIN_FILE
# 
# Check the documents
#   - https://github.com/microsoft/vcpkg/blob/master/docs/users/manifests.md
#   - https://github.com/microsoft/vcpkg/tree/master/docs/examples/vcpkg_android_example_cmake_script
#
...
if (true)
    ...
    message(STATUS "vcpkg_android.cmake: VCPKG_TARGET_TRIPLET was set to ${VCPKG_TARGET_TRIPLET}")
    ...
    # message(STATUS "vcpkg_android.cmake: CMAKE_TOOLCHAIN_FILE was set to ${CMAKE_TOOLCHAIN_FILE}")
    # message(STATUS "vcpkg_android.cmake: VCPKG_CHAINLOAD_TOOLCHAIN_FILE was set to ${VCPKG_CHAINLOAD_TOOLCHAIN_FILE}")
